...
These stats are indicating that the wage gap isn't as bad as the left says it is, but it does seem to lean in favor of men.  I wouldn't describe the wage gap as "women are making 80 cents for every dollar a man makes."  I think it's inappropriate and more prone to misinterpretation to summarize millions of worker's salaries with a single number/ratio.  The wage gap is complex and there are a wide spectrum of salaries across all fields depending on many variables.  In the best case scenario for women, they are making $1.24 for every $1 a man makes, and in the worst case, they are making 66 cents for every dollar a man makes.  With this complexity in mind, looking at just the median could cause you to make false assumptions.  For example, check out "Billing and Posting Clerks" in the category where pay favors men over women.  The median is less for women, but the max is more for women by almost 4x.  This just goes to show that these stats don't tell the whole story.  We need more data to figure out what the driving factors are behind the wage gap.
